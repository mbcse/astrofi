...
async function main () {
  ...
  console.log(`Upgrading ZodiacDAO contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade ZodiacDAO contract
  console.log("\nUpgrading ZodiacDAO...");
  ...
  console.log("\n✅ ZodiacDAO contract upgraded successfully!");
}
