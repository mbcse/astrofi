...
async function main () {
  ...
  console.log(`Upgrading TimedStakePool contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade TimedStakePool contract
  console.log("\nUpgrading TimedStakePool...");
  ...
  console.log("\n✅ TimedStakePool contract upgraded successfully!");
}
