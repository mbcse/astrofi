...
async function main () {
  ...
  console.log(`Upgrading DailyPredictionStaking contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade DailyPredictionStaking contract
  console.log("\nUpgrading DailyPredictionStaking...");
  ...
  console.log("\n✅ DailyPredictionStaking contract upgraded successfully!");
}
