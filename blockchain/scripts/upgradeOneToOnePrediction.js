...
async function main () {
  ...
  console.log(`Upgrading OneToOnePrediction contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade OneToOnePrediction contract
  console.log("\nUpgrading OneToOnePrediction...");
  ...
  console.log("\n✅ OneToOnePrediction contract upgraded successfully!");
}
