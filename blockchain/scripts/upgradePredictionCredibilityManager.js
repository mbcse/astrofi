...
async function main () {
  ...
  console.log(`Upgrading PredictionCredibilityManager contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade PredictionCredibilityManager contract
  console.log("\nUpgrading PredictionCredibilityManager...");
  ...
  console.log("\n✅ PredictionCredibilityManager contract upgraded successfully!");
}
