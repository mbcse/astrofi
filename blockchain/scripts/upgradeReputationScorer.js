...
async function main () {
  ...
  console.log(`Upgrading ReputationScorer contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade ReputationScorer contract
  console.log("\nUpgrading ReputationScorer...");
  ...
  console.log("\n✅ ReputationScorer contract upgraded successfully!");
}
