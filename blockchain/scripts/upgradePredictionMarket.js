...
async function main () {
  ...
  console.log(`Upgrading PredictionMarket contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade PredictionMarket contract
  console.log("\nUpgrading PredictionMarket...");
  ...
  console.log("\n✅ PredictionMarket contract upgraded successfully!");
}
