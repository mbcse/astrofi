...
async function main () {
  ...
  console.log(`Upgrading BuyTokenContract contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade BuyTokenContract contract
  console.log("\nUpgrading BuyTokenContract...");
  ...
  console.log("\n✅ BuyTokenContract contract upgraded successfully!");
}
