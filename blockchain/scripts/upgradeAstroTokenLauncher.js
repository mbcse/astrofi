...
async function main () {
  ...
  console.log(`Upgrading AstroTokenLauncher contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade AstroTokenLauncher contract
  console.log("\nUpgrading AstroTokenLauncher...");
  ...
  console.log("\n✅ AstroTokenLauncher contract upgraded successfully!");
}
