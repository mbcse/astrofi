...
async function main () {
  ...
  console.log(`Upgrading WorldPredictionMarket contract on ${deployHelpers.CHAIN_NAME} (Chain ID: ${deployHelpers.chainId})`);

  // Upgrade WorldPredictionMarket contract
  console.log("\nUpgrading WorldPredictionMarket...");
  ...
  console.log("\n✅ WorldPredictionMarket contract upgraded successfully!");
}
